...
public class BlogPostController {
	//Tell spring boot to set these automatically via INJECTION
	@Autowired
...
//		Now we are going to use the id to load the blogpost from the database table that has that id.
	...
	public String updateExisitingPost(@PathVariable Long id, BlogPost blogPost, Model model) {
		Optional<BlogPost> post = blogPostRepository.findById(id);
